...
ActiveRecord::Schema.define(version: 2021_11_25_075138) do
  ...
  create_table "excuse_tag_relations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["excuse_id"], name: "index_excuse_tag_relations_on_excuse_id"
    t.index ["tag_id"], name: "index_excuse_tag_relations_on_tag_id"
  end

  create_table "excuses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "reason"
    t.string "result"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_excuses_on_user_id"
  end
